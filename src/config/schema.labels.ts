...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.brainIngest": "Brain Ingest Bridge",
  "memory.brainIngest.enabled": "Enable Brain Ingest",
  "memory.brainIngest.url": "Shared-Brain URL",
  "memory.brainIngest.deviceId": "Device ID",
  "memory.brainIngest.keyPath": "Device Key Path",
  "memory.brainIngest.project": "Ingest Project Tag",
  "memory.brainIngest.type": "Ingest Memory Type",
  "memory.brainIngest.importance": "Ingest Importance",
  "memory.brainIngest.tags": "Ingest Extra Tags",
  "memory.brainIngest.timeoutMs": "Ingest Timeout (ms)",
